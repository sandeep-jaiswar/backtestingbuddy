...
const Button = React.forwardRef<HTMLButtonElement, ButtonProps>((
  ...
  switch (variant) {
    ...
    case 'tinted':
      ...
      variantClasses = 'bg-[--ui-action-primary-tint-bg] text-[--ui-action-primary-tint-text] hover:bg-[--ui-action-primary-bg]/30 focus:ring-[--ui-border-focus]';
      break;
    case 'gray':
    ...
    case 'plain':
      ...
      variantClasses = 'text-[--ui-text-accent] hover:text-[--ui-text-accent] focus:ring-[--ui-border-focus] focus:bg-[--ui-action-primary-tint-bg]';
      break;
    default:
